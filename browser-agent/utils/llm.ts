...
export async function decideWithLLM(instruction: AgentInstruction, job: JobCard): Promise<AgentDecision> {
...
export function mockDecision(instruction: AgentInstruction, job: JobCard, suffix = "keyword match"): AgentDecision {
